...
return {
	...
	["sp_cards"] = "Bản SP",--SP卡牌包
	["sp_moonspear"] = "Ngân Nguyệt Thương",--银月枪
	[":sp_moonspear"] = "Thẻ trang bị - Vũ khí<br /><b>Tầm đánh</b>： 3<br /><b>Hiệu quả</b>： Ngoài lượt hành động, mỗi khi bạn sử dụng 1 lá đen, bạn có thể Sát lên 1 người chơi khác.",
	--装备牌·武器<br /><b>攻击范围</b>：３<br /><b>武器技能</b>：你的回合外，每当你使用或打出一张黑色牌时，你可以令你攻击范围内的一名角色打出一张【闪】，否则该角色受到1点伤害
	["@sp_moonspear"] = "Chọn người chơi trong tầm",--请选择攻击范围内的一名角色令其打出一张【闪】
	["@moon-spear-jink"] = "Ngân Nguyệt Thương được kích hoạt, hãy đưa ra lá Tránh.",--【银月枪】效果被触发，请打出一张【闪】
