...
return {
	...
	["#caorui"] = "Thiên Tư Đích Minh Quân",--天姿的明君
	["caorui"] = "Tào Duệ",--曹叡
	["huituo"] = "Khôi Tháp",--恢拓
	[":huituo"] = "Khi bạn bị thương, bạn có thể cho 1 người rút phát xét: nếu là đỏ, họ được hồi 1 máu, nếu là đen, họ được rút X lá. X là số lá đã mất.",--每当你受到伤害后，你可以令一名角色进行一次判定，若结果为红色，该角色回复1点体力；若结果为黑色，该角色摸X张牌（X为此次伤害的伤害数）。
    ["@huituo-select"] = "Bạn sử dụng Khôi Tháp. \nHướng dẫn: Chọn ai đó → Bấm OK" ,--你可以发动“恢拓”。\n操作提示：选择一名角色→点击确定
	["mingjian"] = "Minh Giám",--明鉴
	[":mingjian"] = "Bạn có thể bỏ qua lượt hành động, và đưa hết bài cho ai đó, họ được đi thêm lần nữa.",--你可以跳过出牌阶段并将所有手牌交给一名其他角色。若如此做，你结束此回合，然后该角色进行一个额外的出牌阶段。
    ["@mingjian-give"] = "Bạn sài Minh Giám \n Hướng dẫn: Chọn ai đó → Bấm OK" ,--你可以发动“明鉴”。\n操作提示：选择一名角色→点击确定
	["xingshuai"] = "Hưng Suy",--兴衰
	[":xingshuai"] = "Chủ Công Kĩ. Hạn Định Kĩ. Khi bạn sắp chết, tướng Ngụy khác có thể cho bạn 1 máu.",--主公技。限定技。当你进入濒死状态时，其他魏势力角色可依次令你回复1点体力，然后这些角色依次受到1点伤害。
    ["_xingshuai:xing"] = "Bạn có thể cho Vua 1 máu." ,--你可以令主公回复一点体力，然后你受到1点伤害

	["#caoxiu"] = "Thiên Lí Kì Kí",--千里骐骥
	["caoxiu"] = "Tào Hưu",--曹休
	["taoxi"] = "Thảo Tập",--讨袭
	[":taoxi"] = "出牌阶段限一次，你使用牌指定一名其他角色为唯一目标后，你可以亮出其一张手牌直到回合结束，并且你可以于此回合内将此牌如手牌般使用。回合结束时，若该角色未失去此手牌，则你失去1点体力。",--出牌阶段限一次，你使用牌指定一名其他角色为唯一目标后，你可以亮出其一张手牌直到回合结束，并且你可以于此回合内将此牌如手牌般使用。回合结束时，若该角色未失去此手牌，则你失去1点体力。
	["&taoxi"] = "讨袭",
