...
return {
	["nostalgia"] = "Hoài Cựu",--怀旧卡牌

	["moon_spear"] = "Ngân Nguyệt Thương X",--银月枪X
	[":moon_spear"] = "Thẻ trang bị - Vũ Khí <br /><b>Tầm đánh</b>： 3<br /><b>Hiệu quả:</b>trong lượt hành động, khi sử dụng 1 lá đen, bạn được gây 1 Sát lên người chơi khác.",
	--装备牌·武器<br /><b>攻击范围</b>：３<br /><b>武器技能</b>：你的回合外，每当你使用或打出了一张黑色牌时，你可以使用一张【杀】
	["@moon-spear-slash"] = "Ngân Nguyệt Thương được kích hoạt, hãy đưa ra lá Tránh.",--【银月枪】效果被触发，你可以使用一张【杀】
